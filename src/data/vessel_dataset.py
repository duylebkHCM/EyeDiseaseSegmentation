...
class OneLesionSegmentation(Dataset):
    def __init__(self, images: List[str], is_gray: bool, masks: List[str] = None, transform=None, preprocessing_fn=None, ben_transform = None, data_type = 'all'):
        self.images = images
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        if self.preprocessing_fn is not None:
            image = self.preprocessing_fn(x=image)
...
class TestSegmentation(Dataset):
    def __init__(self, images: List[str], is_gray: bool, masks: List[str] = None, transform=None, factor=None):
        self.images = images
        self.masks = masks
        self.transform = transform
        self.factor = factor
