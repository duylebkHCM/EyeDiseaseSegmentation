...
class UNet_3Plus_DeepSup(nn.Module):
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True, deep_supervision=False):
...
if __name__ == '__main__':
    model = UNet_3Plus_DeepSup(deep_supervision=True).cuda()

    a = torch.rand(2, 3, 128, 128).cuda()

    output, d_output = model(a)
